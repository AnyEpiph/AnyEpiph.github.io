...
由于稳定独立增量的性质，并且已知 $$f_t(x)$$恰好是正态分布 $$\mathcal{N}\left(0,c^2 t\right)$$的概率密度函数，我们可以轻松地写出 $$f_{s \vert t} (x \vert B)$$，进而求出 $$X(s),s<t$$的条件期望
...
额外吐槽一句，Notion导出的Markdown文件真的不靠谱啊，改了半天......
